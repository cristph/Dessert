                        ...
                        <div id="J_CheckDue" class="due float">
                            <div class="realPay" id="realPay_1">
                                ...
                                <span class="bd">
                                    ...
                                    <strong id="J_RealPay">${item.sorderitem.tprice}</strong>
                                </span>
                                </p>
                            </div>
                                    ...
                                    <div class="modal-body">
                                        <form class="form-wrapper">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" style="margin-left: 5%; width: 70%" id="money" value=${item.sorderitem.tprice} disabled="true">
                                            </div>
                                            <div class="form-group">
...
<script src="js/sellcart.js"></script>
</body>
</html>
