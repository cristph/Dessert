                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:forEach items="${list}" var="item">
                                    <div class="col-sm-3">
                                        <div class="thumbnail">
                                            <a href="${pageContext.request.contextPath}/store?category=cake&shopid=${item.shopid}">
                                                <img  alt="100%x200" src="${item.shoppic}"  style="height: 200px; width: 100%; display: block;">
                                            </a>
                                            <div class="caption">
                                                <p class="productPrice"><em title="45.00">${item.shopname}</em></p>
                                                <div class="productTitle"><a href="" >${item.address}</a></div>
                                                <div class="productTitle"></div>
                                                <div class="productTitle"><a href="" >${item.contact}</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </c:forEach>
